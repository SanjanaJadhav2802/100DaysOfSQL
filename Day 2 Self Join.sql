...
-- find out emp who are having salary greater than manager(self join)
select e.emp_name as emp_name,m.emp_name as manager_name,e.salary as emp_salary,m.salary as manager_salary from emp e inner join emp m
